package com.gis.gis.exceptions;
...
public class ControllerExceptionHandler {
  ...
  public ResponseEntity<ErrorMessage> gatewayTimeoutException(GatewayTimeoutException ex,
      WebRequest request) {
    ErrorMessage message = new ErrorMessage(HttpStatus.GATEWAY_TIMEOUT.value(), new Date(),
        ex.getMessage(), request.getDescription(false));
    return new ResponseEntity<ErrorMessage>(message, HttpStatus.GATEWAY_TIMEOUT);
  }
