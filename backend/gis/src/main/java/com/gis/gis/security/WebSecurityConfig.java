package com.gis.gis.security;

import java.util.Arrays;

import com.gis.gis.security.filters.AuthHeaderFilter;
import com.gis.gis.security.jwt.AuthEntryPointJwt;
import com.gis.gis.security.jwt.AuthTokenFilter;
  ...
  SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http.cors(configurer -> configurer.configurationSource(source))
        ...
        .authorizeHttpRequests(
            registry -> registry
                .requestMatchers(antMatcher("/auth/**"), antMatcher("/files/**"), antMatcher("/users/**"))
